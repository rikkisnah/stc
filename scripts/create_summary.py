...
Usage:
    python3 scripts/create_summary.py --tickets scripts/analysis/tickets-categorized.csv
    python3 scripts/create_summary.py --tickets scripts/analysis/tickets-categorized.csv --output scripts/analysis/tickets-summary.csv
"""
...
DEFAULT_TICKETS_CSV = Path(__file__).resolve().parent / "analysis" / "tickets-categorized.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--tickets",
        type=Path,
        default=DEFAULT_TICKETS_CSV,
        help=(
            "Path to tickets-categorized.csv generated by rule_engine_categorize.py "
            f"(default: {DEFAULT_TICKETS_CSV})"
        ),
    )
    parser.add_argument(
        "--output",
